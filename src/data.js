...
const ui = {
  en: {
    ...
    diaryLocalOnly: "Translation is not available yet. The original diary is saved.",
  ...
  jp: {
    ...
    diaryLocalOnly: "翻訳はまだ利用できません。元の日記は保存されています。",
  ...
  mm: {
    ...
    diaryLocalOnly: "ဘာသာပြန်ခြင်းကို မရနိုင်သေးပါ။ မူရင်းမှတ်တမ်းကို သိမ်းထားပြီးဖြစ်သည်။",
