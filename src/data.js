...
const routineTasks = [
  ...
  routine("washer-deep-clean", "quarterly", 10, "W", 
    ...
    t("Quarterly guided deep clean of the detergent drawer, drain-pump filter, rubber door seal, exterior and washing-machine tub. The drum must be empty.", "洗剤引き出し、排水ポンプフィルター、ドアのゴムパッキン、外装、洗濯槽の3ヶ月ごとのガイド付き大掃除。ドラムは空にしてください。", "ဆပ်ပြာအံဆွဲ၊ ရေထုတ်ပန့်ဇကာ၊ တံခါးရာဘာကွင်း၊ အပြင်ပိုင်းနှင့် အဝတ်လျှော်စက်အတွင်းပိုင်း (tub) တို့ကို ၃ လတစ်ကြိမ် လမ်းညွှန်ချက်ဖြင့် သန့်ရှင်းရေးအကြီးစားလုပ်ရန်။ ဒရမ်သည် ဗလာဖြစ်နေရမည်။"), 
...
if (washerDeepCleanRoutine) {
  washerDeepCleanRoutine.instructions = [
    t("1. Prepare safely\n- Make sure the drum is empty.\n- Switch off and unplug the washing machine.\n- Allow any hot water inside the machine to cool before opening the pump-filter area.\n- Prepare towels, a shallow tray and a small brush.",
      "1. 安全に準備する\n- ドラムが空であることを確認します。\n- 洗濯機の電源を切り、プラグをコンセントから抜きます。\n- ポンプフィルター部分を開ける前に、洗濯機内部の温水が冷めるまで待ちます。\n- タオル、浅いトレイ、小さなブラシを用意します。",
      "၁။ ဘေးကင်းစွာ ပြင်ဆင်ရန်\n- ဒရမ်ထဲတွင် အဝတ်အစားများ မရှိကြောင်း သေချာပါစေ။\n- အဝတ်လျှော်စက်ကို ပိတ်ပြီး ပလပ်ဖြုတ်ထားပါ။\n- ပန့်ဇကာနေရာကို မဖွင့်မီ စက်ထဲရှိ ရေနွေးများ အေးသွားသည်အထိ စောင့်ပါ။\n- တဘက်များ、တိမ်သောလင်ပန်းနှင့် ဘရက်ရှ်အသေးတစ်ချောင်းတို့ကို ပြင်ဆင်ထားပါ။"),
    t("2. Clean the detergent drawer\n- Pull out the detergent drawer.\n- Press the release tab if needed and remove the drawer completely.\n- Rinse it with warm water.\n- Use a soft brush to remove detergent and softener residue.\n- Wipe the inside of the drawer housing.\n- Dry and reinstall the drawer securely.",
      "2. 洗剤引き出しを掃除する\n- 洗剤引き出しを手前に引き出します。\n- 必要に応じてリリースタブ（解除ボタン）を押し、引き出しを完全に外します。\n- 温水で洗い流します。\n- 柔らかいブラシを使って、洗剤や柔軟剤の残りカスを取り除きます。\n- 引き出しのハウジング（挿入部）の内部を拭きます。\n- 乾かしてから、引き出しをしっかりと元に戻します。",
      "၂။ ဆပ်ပြာအံဆွဲကို သန့်ရှင်းရေးလုပ်ရန်\n- ဆပ်ပြာအံဆွဲကို ဆွဲထုတ်ပါ။\n- လိုအပ်ပါက လွှတ်ပေးသည့် tab (ခလုတ်) ကိုနှိပ်ပြီး အံဆွဲကို လုံးဝဖြုတ်ယူပါ။\n- ရေနွေးနွေးဖြင့် ဆေးကြောပါ။\n- ဆပ်ပြာနှင့် softener (အဝတ်ပျော့ဆေး) အကြွင်းအကျန်များကို ဖယ်ရှားရန် ဘရက်ရှ်အနုကို အသုံးပြုပါ။\n- အံဆွဲအိမ် (အတွင်းပိုင်း) ကို သုတ်ပါ။\n- ခြောက်အောင်သုတ်ပြီး အံဆွဲကို သေချာစွာ ပြန်တပ်ပါ။"),
    t("3. Clean the drain-pump filter\n- Open the small access flap at the bottom front of the washer.\n- Put towels and a shallow tray underneath.\n- Pull out the emergency drain hose.\n- Remove its cap slowly and drain the remaining water into the tray.\n- Replace the drain-hose cap securely.\n- Turn the pump-filter cap anticlockwise and remove it.\n- Remove hair, lint, coins and other debris.\n- Rinse the filter with clean water.\n- Check the filter opening for visible debris without inserting tools deeply.\n- Reinstall and tighten the filter securely.\n- Return the emergency hose to its holder and close the flap.",
      "3. 排水ポンプフィルターを掃除する\n- 洗濯機前面の下部にある小さなアクセスフラップ（カバー）を開きます。\n- 下にタオルと浅いトレイを置きます。\n- 非常用排水ホースを引き出します。\n- キャップをゆっくりと外し、残っている水をトレイに排出します。\n- 排水ホースのキャップをしっかりと閉め直します。\n- ポンプフィルターのキャップを反時計回りに回して外します。\n- 髪の毛、糸くず、硬貨、その他のゴミを取り除きます。\n- フィルターをきれいな水ですすぎます。\n- 道具を奥まで差し込まずに、フィルター開口部にゴミがないか目視で確認します。\n- フィルターを元に戻し、しっかりと締め直します。\n- 非常用ホースをホルダーに戻し、フラップを閉じます。",
      "၃။ ရေထုတ်ပန့် filter ကို သန့်ရှင်းရေးလုပ်ရန်\n- အဝတ်လျှော်စက် ရှေ့ဘက်အောက်ခြေရှိ အဖုံးအသေးလေးကို ဖွင့်ပါ။\n- အောက်တွင် တဘက်များနှင့် တိမ်သောလင်ပန်းကို ချထားပါ။\n- အရေးပေါ် ရေထုတ်ပိုက်ကို ဆွဲထုတ်ပါ။\n- ၎င်း၏ အဖုံးကို ဖြည်းညှင်းစွာဖွင့်ပြီး ကျန်ရှိသောရေများကို လင်ပန်းထဲသို့ ထုတ်ပါ။\n- ရေထုတ်ပိုက်အဖုံးကို သေချာစွာ ပြန်ပိတ်ပါ။\n- ပန့် filter အဖုံးကို နာရီလက်တံပြောင်းပြန်လှည့်၍ ဖြုတ်ပါ။\n- ဆံပင်、ဖုန်မှုန့်၊ အကြွေစေ့များနှင့် အခြားအမှိုက်များကို ဖယ်ရှားပါ။\n- filter ကို ရေသန့်ဖြင့် ဆေးကြောပါ။\n- filter အပေါက်ထဲသို့ ကိရိယာများ အနက်ကြီးမထည့်ဘဲ မြင်သာသောအမှိုက်များ ရှိမရှိ စစ်ဆေးပါ။\n- filter ကို ပြန်တပ်ပြီး သေချာစွာ တင်းကျပ်အောင် ပိတ်ပါ။\n- အရေးပေါ်ရေထုတ်ပိုက်ကို ၎င်း၏နေရာသို့ ပြန်ထည့်ပြီး အဖုံးကို ပိတ်ပါ။"),
    t("4. Clean the rubber door seal\n- Gently pull back the folds of the rubber seal.\n- Remove hair, dirt and trapped objects.\n- Wipe the seal using a damp cloth.\n- If mould is present, use only a washing-machine-safe mould cleaner or properly diluted bleach.\n- Rinse the treated area thoroughly and wipe it dry.",
      "4. ドアのゴムパッキンを掃除する\n- ゴムパッキンの折り目を優しくめくります。\n- 髪の毛、汚れ、挟まっている異物を取り除きます。\n- 固く絞った濡れ雑巾でパッキンを拭きます。\n- カビがある場合は、洗濯機用の防カビ剤または適切に希釈した漂白剤のみを使用してください。\n- 処理した部分を十分に水拭きし、乾いた布で水分を拭き取ります。",
      "၄။ တံခါးရာဘာကွင်းကို သန့်ရှင်းရေးလုပ်ရန်\n- ရာဘာကွင်း၏ ခေါက်များကို ညင်သာစွာ ဆွဲလှန်ပါ။\n- ဆံပင်၊ ဖုန်များနှင့် ညပ်နေသောပစ္စည်းများကို ဖယ်ရှားပါ။\n- စိုစွတ်သော အဝတ်ဖြင့် ရာဘာကွင်းကို သုတ်ပါ။\n- မှိုများရှိပါက အဝတ်လျှော်စက်အတွက် ဘေးကင်းသော မှိုသတ်ဆေး သို့မဟုတ် သေချာစွာ ရောစပ်ထားသော ချွတ်ဆေးကိုသာ အသုံးပြုပါ။\n- သန့်စင်ထားသောနေရာကို ရေစင်အောင်ဆေးပြီး ခြောက်သွေ့အောင် သုတ်ပါ။"),
    t("5. Wipe the machine\n- Wipe the door glass, control panel and outside surfaces with a damp cloth.\n- Dry the surfaces afterward.\n- Do not spray water directly onto the controls or electrical areas.",
      "5. 洗濯機を拭く\n- ドアガラス、コントロールパネル、外側の表面を濡れた布で拭きます。\n- その後、表面を乾拭きします。\n- 操作部や電気部分に直接水をスプレーしないでください。",
      "၅။ စက်ကို သုတ်ရန်\n- တံခါးမှန်၊ control panel နှင့် အပြင်ဘက်မျက်နှာပြင်များကို စိုစွတ်သော အဝတ်ဖြင့် သုတ်ပါ။\n- ထို့နောက် မျက်နှာပြင်များကို ခြောက်အောင် သုတ်ပါ။\n- ခလုတ်များ သို့မဟုတ် လျှပ်စစ်အစိတ်အပိုင်းများပေါ်သို့ ရေကို တိုက်ရိုက် မဖြန်းပါနှင့်။"),
    t("6. Run Tub Clean\n- Keep the drum empty.\n- Use the built-in Tub Clean programme.\n- Use only a cleaner approved for front-loading washing machines and follow the cleaner’s label.\n- Do not add clothing during this cycle.",
      "6. 槽洗浄コースを実行する\n- ドラムは空のままにします。\n- 洗濯機に内蔵されている槽洗浄（Tub Clean）コースを使用します。\n- ドラム式（フロントロード）洗濯機用として承認されたクリーナーのみを使用し、クリーナーのラベルの指示に従ってください。\n- このサイクル中は衣類を入れないでください。",
      "၆။ Tub Clean လုပ်ဆောင်ချက်ကို ဖွင့်ရန်\n- ดရမ်ထဲတွင် အဝတ်အစားများ မရှိစေရ။\n- စက်တွင်ပါရှိသော Tub Clean အစီအစဉ်ကို အသုံးပြုပါ။\n- ရှေ့ဖွင့် (front-loading) အဝတ်လျှော်စက်များအတွက် ခွင့်ပြုထားသော သန့်စင်ဆေးကိုသာ အသုံးပြုပြီး သန့်စင်ဆေးဘူးပေါ်ရှိ လမ်းညွှန်ချက်ကို လိုက်နာပါ။\n- ဤစက်လည်ပတ်နေစဉ်အတွင်း အဝတ်အစားများ မထည့်ပါနှင့်။"),
    t("7. Dry the washer\n- After the cycle finishes, wipe away remaining moisture.\n- Leave the door and detergent drawer slightly open so the washer can dry.",
      "7. 洗濯機を乾かす\n- サイクルが終了したら、残った水分を拭き取ります。\n- 洗濯機が乾くように、ドアと洗剤引き出しを少し開けたままにしておきます。",
      "၇။ အဝတ်လျှော်စက်ကို အခြောက်ခံရန်\n- စက်လည်ပတ်မှုပြီးနောက် ကျန်ရှိသော စိုစွတ်မှုများကို သုတ်ပါ။\n- စက်ခြောက်သွေ့စေရန် တံခါးနှင့် ဆပ်ပြာအံဆွဲကို အနည်းငယ် ဟထားပါ။")
  ];
  washerDeepCleanRoutine.mustRemember = [
    t("Do this task only when Edwin asks and supervises.",
      "この作業は、Edwinが依頼し監督する場合にのみ行ってください。",
      "Edwin က တောင်းဆိုပြီး ကြီးကြပ်သည့်အခါမှသာ ဤအလုပ်ကို လုပ်ပါ။"),
    t("Never mix bleach with vinegar, acids, ammonia or another cleaner.",
      "漂白剤を酢、酸、アンモニア、または他のクリーナーと絶対に混ぜないでください。",
      "ချွတ်ဆေးကို ဗာနီဂါ၊ အက်စစ်၊ အမ်မိုနီးယား သို့မဟုတ် အခြားသန့်စင်ဆေးများနှင့် လုံးဝမရောပါနှင့်။"),
    t("Do not use vinegar or citric acid for deep clean; use only approved front-loading washer tub cleaner with the built-in Tub Clean programme.",
      "徹底洗浄に酢やクエン酸を使用しないでください。洗濯機に内蔵されている槽洗浄（Tub Clean）コースを使用し、承認されたドラム式洗濯機用クリーナーのみを使用してください。",
      "သန့်ရှင်းရေးအကြီးစားအတွက် ဗာနီဂါ သို့မဟုတ် citric acid ကို မသုံးပါနှင့်။ စက်တွင်ပါရှိသော Tub Clean အစီအစဉ်နှင့် ခွင့်ပြုထားသော ရှေ့ဖွင့်အဝတ်လျှော်စက်သန့်စင်ဆေးကိုသာ အသုံးပြုပါ။"),
    t("Do not dismantle internal panels or reach deeply into the pump opening.",
      "内部のパネルを分解したり、ポンプ開口部の奥深くまで手を入れないでください。",
      "အတွင်းပိုင်း panel များကို ဖြုတ်ခြင်း သို့မဟုတ် ပန့်အပေါက်ထဲသို့ လက်အနက်ကြီး နှိုက်ခြင်း မပြုပါနှင့်။"),
    t("Make sure the pump filter and drain-hose cap are securely replaced before using the washer again.",
      "洗濯機を再度使用する前に、ポンプフィルターと排水ホースのキャップがしっかりと元の位置に戻されていることを確認してください。",
      "စက်ကို ပြန်မသုံးမီ ပန့်ဇကာနှင့် ရေထုတ်ပိုက်အဖုံးတို့ကို သေချာစွာ ပြန်ပိတ်ပြီးကြောင်း စစ်ဆေးပါ။"),
    t("Water-inlet filters: Do not clean them as a normal quarterly step. Check them only when water enters slowly or displays a water-inlet error, and perform this only under Edwin's guidance after turning off the water tap.",
      "給水フィルター：通常の3ヶ月ごとの手順としては掃除しないでください。水の流れが遅い場合や給水エラーが表示された場合のみ確認し、必ず水栓を閉めた状態で、Edwinの指導のもとでのみ行ってください。",
      "ရေဝင် filter များ- ပုံမှန် ၃ လတစ်ကြိမ် လုပ်ရမည့်အဆင့်တွင် မသန့်ရှင်းပါနှင့်။ ရေဝင်နှေးသည့်အခါ သို့မဟုတ် ရေဝင် error ပြသည့်အခါမှသာ စစ်ဆေးပြီး ရေခေါင်းကိုပိတ်ပြီးနောက် Edwin ၏ လမ်းညွှန်မှုအောက်တွင်သာ လုပ်ဆောင်ပါ။")
  ];
  washerDeepCleanRoutine.videoUrl = "https://www.lg.com/levant_ar/support/video-tutorials/CT20156023-20152666042092";
