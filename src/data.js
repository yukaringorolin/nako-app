...
const ui = {
  en: {
    ...
    mealLogsLatest: "Latest daily total",
    mealLogsRecent: "Recent daily totals",
    mealLogsRefresh: "Refresh",
    mealLogsRefreshing: "Refreshing...",
    mealLogsLastRefresh: "Last refresh (Singapore time)",
    mealLogsNotRefreshed: "Not refreshed yet",
    mealLogsNoData: "No daily totals are available yet.",
    mealLogsRefreshError: "Could not refresh meal logs. Try again.",
    mealLogsRefreshErrorCached: "Could not refresh meal logs. Showing the last saved data.",
    ...
    routineReminderTitle: "Due soon",
    routineReminderDueToday: "Due today",
    routineReminderDueTomorrow: "Due tomorrow",
    routineReminderDueInDays: "Due in {count} days",
    routineReminderMore: "+{count} more",
  ...
  jp: {
    ...
    mealLogsLatest: "最新の1日合計",
    mealLogsRecent: "最近の1日合計",
    mealLogsRefresh: "更新",
    mealLogsRefreshing: "更新中...",
    mealLogsLastRefresh: "最終更新（シンガポール時間）",
    mealLogsNotRefreshed: "まだ更新されていません",
    mealLogsNoData: "1日合計のデータはまだありません。",
    mealLogsRefreshError: "食事記録を更新できませんでした。もう一度お試しください。",
    mealLogsRefreshErrorCached: "食事記録を更新できませんでした。最後に保存したデータを表示しています。",
    ...
    routineReminderTitle: "期限が近いタスク",
    routineReminderDueToday: "今日が期限",
    routineReminderDueTomorrow: "明日が期限",
    routineReminderDueInDays: "あと{count}日",
    routineReminderMore: "ほか{count}件",
  ...
  mm: {
    ...
    openGoogleMaps: "Google Maps မှာ ဖွင့်ရန်",
    ...
    mealLogsLatest: "နောက်ဆုံးနေ့စဉ်စုစုပေါင်း",
    mealLogsRecent: "မကြာသေးမီ နေ့စဉ်စုစုပေါင်းများ",
    mealLogsRefresh: "အသစ်ပြန်တင်ရန်",
    mealLogsRefreshing: "အသစ်ပြန်တင်နေသည်...",
    mealLogsLastRefresh: "နောက်ဆုံးအသစ်ပြန်တင်ချိန် (စင်ကာပူအချိန်)",
    mealLogsNotRefreshed: "မတင်ရသေးပါ။",
    mealLogsNoData: "နေ့စဉ်စုစုပေါင်း မရှိသေးပါ။",
    mealLogsRefreshError: "အစားအသောက်မှတ်တမ်းကို အသစ်ပြန်တင်၍ မရပါ။ ထပ်စမ်းပါ။",
    mealLogsRefreshErrorCached: "အစားအသောက်မှတ်တမ်းကို အသစ်ပြန်တင်၍ မရပါ။ နောက်ဆုံးသိမ်းထားသောဒေတာကို ပြထားပါသည်။",
    ...
    routineReminderTitle: "မကြာမီ လုပ်ရန်",
    routineReminderDueToday: "ဒီနေ့ လုပ်ပြီးရမည်",
    routineReminderDueTomorrow: "မနက်ဖြန် လုပ်ပြီးရမည်",
    routineReminderDueInDays: "{count} ရက်အတွင်း လုပ်ပြီးရမည်",
    routineReminderMore: "နောက်ထပ် {count} ခု",
...
const cookingRules = [
  ...
  t("Do not use coriander, parsley, or bean sprouts. Use onion only when an approved human recipe lists it, and never feed any onion dish to Nako.", "パクチー、パセリ、もやしは使わないでください。玉ねぎは承認済みの人用レシピに記載されている場合だけ使い、玉ねぎ入りの料理は絶対にナコへ与えないでください。", "နံနံပင်၊ parsley သို့မဟုတ် ပဲပင်ပေါက်ကို မသုံးပါနှင့်။ ခွင့်ပြုထားသော လူစားဟင်းချက်နည်းတွင် ပါမှသာ ကြက်သွန်နီသုံးပါ။ ကြက်သွန်နီပါသောဟင်းကို Nako ကို လုံးဝမကျွေးပါနှင့်။"),
...
const routineTasks = [
  ...
  routine("daily-cooking", "daily", 15, "C",
    ...
    t("Do not use coriander, parsley, or bean sprouts. Use onion only when an approved human recipe lists it, and never feed any onion dish to Nako. Keep food and snacks out of bedrooms; use only the kitchen, dining, or living areas.", "パクチー、パセリ、もやしは使わないでください。玉ねぎは承認済みの人用レシピに記載されている場合だけ使い、玉ねぎ入りの料理は絶対にナコへ与えないでください。寝室に食べ物やお菓子を持ち込まず、キッチン、ダイニング、リビングだけで扱ってください。", "နံနံပင်၊ parsley သို့မဟုတ် ပဲပင်ပေါက်ကို မသုံးပါနှင့်။ ခွင့်ပြုထားသော လူစားဟင်းချက်နည်းတွင် ပါမှသာ ကြက်သွန်နီသုံးပါ။ ကြက်သွန်နီပါသောဟင်းကို Nako ကို လုံးဝမကျွေးပါနှင့်။ အိပ်ခန်းများတွင် အစားအစာနှင့် snack များ မထားဘဲ မီးဖိုချောင်၊ dining သို့မဟုတ် living area တွင်သာ ထားပါ။"),
    [
...
(() => {
  ...
  window.nakoIngredientCatalog = Object.freeze({
    ...
    "hotcake-mix": { file: null, source: product("/product/yamamori-hot-cake-mix-powder-400-g-90018323"), target: "Japanese hotcake-mix packet" },
    ...
    coffee: { file: null, source: search("instant coffee"), target: "Coffee used for Japanese curry" },
