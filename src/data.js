...
const trainingData = (() => {
  ...
  const commands = [
    ...
    command("lift-carry", "handling", tx("Lift / Carry", "抱き上げ / 抱っこ", "ချီ / ပွေ့"), 0, "High", tx("Stay calm for a brief chest-and-hindquarters support before lifting.", "胸と後ろ足を短く支えられても落ち着いている。", "မတင်မီ ရင်ဘတ်နှင့် နောက်ခြေကို ခဏပံ့ပိုးထားစဉ် ငြိမ်သက်နေရန်။"), "", { order: 11, setting: "liftCue", safety: [tx("Never lift only by the front legs or armpits.", "前足やわきの下だけで持ち上げないでください。", "ရှေ့ခြေ သို့မဟုတ် ချိုင်းအောက်မှသာ မချီပါနှင့်။")]}),
